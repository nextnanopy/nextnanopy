...
folder_examples_nnp = r'C:\Users\stefan.birner.NEXTNANO\Documents\nextnano\nextnanopy\input'
folder_examples_nn3 = r'C:\Users\stefan.birner.NEXTNANO\Documents\nextnano\nextnanopy\input'
...
my_input_file_no_extension_nnp = r'AlGaN_nnp'
my_input_file_no_extension_nn3 = r'AlGaN_nn3'
...
SweepVariable = 'NO_STRAIN'
#SweepVariable = 'STRAIN'
...
#===========================
    ...
    ax.set_xlabel(f"Al alloy content")
    ax.legend()
    ax.set_title("Valence band edges of Al$_x$Ga$_{1-x}$N" + " (" + labelC + ')')
    fig.tight_layout()
  # plt.show()
    filename = 'band_edges'+'_'+SweepVariableString+FigFormat
    fig.savefig(os.path.join(folder_python_output,filename))
