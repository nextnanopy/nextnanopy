...
file_docu.write("\n")
file_docu.write(r"The following Python script was used: ``intersubband_MQW_nextnano3.py``"+"\n")
file_docu.write("\n")
file_docu.write(r"----------------------"+"\n") # horizontal line
file_docu.write("\n")
...
#   sys.exit()
    ...
    #===========================
        ...
        if MQW == 1:
           ...
           NameOfStructure = 'Two Coupled Quantum Wells'
           ...
           NameOfStructure = 'Three Coupled Quantum Wells'
      ...
      # plt.show()
        filename_cb_psi = 'cb_psi'+'_'+NameOfStructureFile+software_short+'.jpg'
...
###CHECK:       color='white', linestyle='-')
        ...
        #        ax.plot(df_cb.coords['position'].value,ws[i],color='yellow')
          ...
          # plt.show()
            filename_abs2D = 'absorption2D'+'_'+NameOfStructureFile+software_short+'.jpg'
