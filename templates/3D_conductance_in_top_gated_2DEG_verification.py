...
k = 26                                  # It corresponds to -1.11 V applied to the top gate
...
# plotting electric potential for -1.11 V
kw.plot(qpc)
potential_plot = kw.plotter.map(qpc, lambda s: qpc_potential(s,)); 
potential_plot.savefig('Potential for -1.11 V.png')
fqpc = qpc.finalized()

# plotting band structure of the lead 0 ( at the left of the device )
bandedges_plot = kw.plotter.bands(fqpc.leads[0]);     
bandedges_plot.savefig('Band structure of the lead 0 for -1.11 V.png')
