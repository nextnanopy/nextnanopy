...
class InputVariable_nn3(InputVariable):
    var_char = nnfmts['nextnano3']['var_char']
    com_char = nnfmts['nextnano3']['com_char']


class InputVariable_nnp(InputVariable):
    var_char = nnfmts['nextnano++']['var_char']
    com_char = nnfmts['nextnano++']['com_char']
